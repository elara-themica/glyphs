...
impl<'de> Deserializer<'de> for GlyphDeserializer<'de> {
    ...
    V: Visitor<'de>,
  {
    ...
    match type_id {
      ...
      GlyphType::VecBool => {
        let vg = BitVecG::from_glyph(self.0)?;
